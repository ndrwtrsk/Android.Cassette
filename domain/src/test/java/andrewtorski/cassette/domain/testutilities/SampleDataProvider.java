package andrewtorski.cassette.domain.testutilities;
...
public abstract class SampleDataProvider {
    ...
    public static List<Cassette> getCassettes() {
        ...
        cassette1 = new Cassette(1, "Cassette #1", "", new Date(), 12000, false, "/", null, 2);
        cassette2 = new Cassette(2, "Cassette #2", "", new Date(), 12000, false, "/", null, 2);
        cassette3 = new Cassette(3, "Cassette #3", "", new Date(), 12000, false, "/", null, 2);
        cassette4 = new Cassette(4, "Cassette #4", "", new Date(), 12000, false, "/", null, 2);
        cassette5 = new Cassette(5, "Cassette #5", "", new Date(), 12000, false, "/", null, 2);
    ...
    public static List<Recording> getRecordings() {
        ...
        recording1 = new Recording(1, 1, "Rec #1", "", new Date(), 600, "/", 1);
        recording2 = new Recording(2, 1, "Rec #2", "", new Date(), 600, "/", 2);
        recording3 = new Recording(3, 2, "Rec #3", "", new Date(), 600, "/", 1);
        recording4 = new Recording(4, 2, "Rec #4", "", new Date(), 600, "/", 2);
        recording5 = new Recording(5, 3, "Rec #5", "", new Date(), 600, "/", 1);
        recording6 = new Recording(6, 3, "Rec #6", "", new Date(), 600, "/", 2);
        recording7 = new Recording(7, 4, "Rec #7", "", new Date(), 600, "/", 1);
        recording8 = new Recording(8, 4, "Rec #8", "", new Date(), 600, "/", 2);
        recording9 = new Recording(9, 5, "Rec #9", "", new Date(), 600, "/", 1);
        recording0 = new Recording(10, 5, "Rec #10", "", new Date(), 600, "/", 2);
